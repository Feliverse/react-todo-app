...
# 📖 To Do List with React + Vite <a name="about-project"></a>

**To Do List** is a tool created using React where you can register import tasks to do day by day
...
[See Live](https://feliverse.github.io/To-Do-List/dist/) 
...
Clone this repository to your desired folder:
 ...
 ```sh
  cd my-folder
  git clone https://github.com/Feliverse/react-todo-app.git
```
--->
